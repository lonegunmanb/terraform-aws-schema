...
const awsRoute53ProfilesResourceAssociation = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func AwsRoute53ProfilesResourceAssociationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsRoute53ProfilesResourceAssociation), &result)
	return &result
}
