...
const awsTimestreaminfluxdbDbInstance = `{
  "block": {
    "attributes": {
      "allocated_storage": {
...
func AwsTimestreaminfluxdbDbInstanceSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsTimestreaminfluxdbDbInstance), &result)
	return &result
}
